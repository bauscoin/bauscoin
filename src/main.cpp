...
uint256 hashGenesisBlock("0x144fe174214549dfcb44aa10f2a33dcf7027e5de05fbfabda78578e8493a94fc");
...
const string strMessageMagic = "BausCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // BausCoin: 1 days
static const int64 nTargetSpacing = 120; // BausCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal bauscoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BausCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x27ee03565662065b8b685066b23634ff8fcedd91ce31017cd9d8cae6eae664c2");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "The say bausoft stuck their dick in the ground and fucked the world.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1387426601; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1533842;

        if (fTestNet)
        {
            block.nTime    = 1386906750;
            block.nNonce   = 376819;
        }
        ...
        assert(block.hashMerkleRoot == uint256("f6ab48254bd85d591f913e7c88cd138ad49ef8c16e27bf6937327da8d7723dd0"));
